...
if grep -E "NVIDIA|GeForce" <<< ${gpu_type}; then
    ...
    pacstrap /mnt xf86-video-amdgpu lib32-mesa lib32-vulkan-radeon vulkan-radeon
    ...
    pacstrap /mnt xf86-video-vmware xf86-input-vmmouse virtualbox-guest-utils lib32-vulkan-virtio vulkan-virtio
fi
